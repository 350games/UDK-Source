...
// The stripifier only used Windows.h for these two fixed-width aliases.  Keep
// this third-party project independent of Windows structure packing so UE3's
// required /Zp4 setting cannot leak into modern SDK headers.
