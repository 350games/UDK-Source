...
namespace UnrealBuildTool
{
	class BuildConfiguration
	{
		...
		/** Optional performance database.  Local builds are self-contained by default. */
		public static string PerfDatabaseName = Utils.GetEnvironmentVariable("ue3.PerfDatabaseName", "");
