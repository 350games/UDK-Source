...
,	bIsPausedByUser( FALSE )
{
	...
	// Shared engine startup movies are data-driven. Game-specific movies must
	// be listed in the game's [FullScreenMovie] configuration instead of being
	// injected into every UDK/editor launch here.
