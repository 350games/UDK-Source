...
private:
	...
	/** TRUE once the built-in handler classes have been requested. */
	UBOOL bHandlersInitialized;

	/** Loads the built-in handlers after singleton construction has completed. */
