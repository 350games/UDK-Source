...
/**
 * The recovered local UTGame target keeps the lean feature profile, but needs
 * the D3D9 shader compiler to create its first-run shader cache.  This is an
 * explicit opt-in so ordinary lean targets retain their original behaviour.
 */
#ifndef WITH_LOCAL_UTGAME_D3D9_SHADER_COMPILER
#define WITH_LOCAL_UTGAME_D3D9_SHADER_COMPILER 0
#endif
...
/** Whether the Windows D3D11 renderer is available. */
#ifndef WITH_D3D11_RHI
#define WITH_D3D11_RHI 1
#endif

/** Whether the desktop OpenGL renderer is available. */
#ifndef WITH_OPENGL_RHI
#define WITH_OPENGL_RHI 1
#endif

/** Whether NVIDIA's NVAPI-based stereo integration is available. */
#ifndef WITH_NVIDIA_STEREO
#define WITH_NVIDIA_STEREO 1
#endif
 ...
 *
 */
// Turn off unless PC Windows. Targets without the NVIDIA tessellation SDK may
// override this independently of the D3D11 RHI selection.
#ifndef WITH_D3D11_TESSELLATION
	#if !CONSOLE //&& !UE3_LEAN_AND_MEAN && defined(_WINDOWS)
		#define WITH_D3D11_TESSELLATION 1
	#else
		#define WITH_D3D11_TESSELLATION 0
	#endif
#endif
...
/** Whether AVI / Matinee movie capture is available on this platform. */
#ifndef WITH_AVIWRITER
#define WITH_AVIWRITER 1
#endif
