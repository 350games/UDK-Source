...
#elif _WIN64 && !WITH_LOCAL_UTGAME_NO_TBB
...
#if WITH_LOCAL_UTGAME
	extern void AutoCheckNativeClassSizesUTGame( UBOOL& Mismatch );
	AutoCheckNativeClassSizesUTGame( Mismatch );
#else
