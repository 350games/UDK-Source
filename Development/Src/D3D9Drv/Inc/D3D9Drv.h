 ...
 */
#if WITH_BUNDLED_D3DX39
	// This recovery target uses the bundled DirectX9 SDK subset, which ships
	// D3DX 39 rather than the original June 2010 D3DX 43 headers and library.
	const INT REQUIRED_D3DX_SDK_VERSION = 39;
#else
