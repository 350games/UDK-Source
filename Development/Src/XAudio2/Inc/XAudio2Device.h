...
protected:
	...
	static UINT32						OutputSampleRate;
	static DWORD						OutputChannelMask;
#else
	static XAUDIO2_DEVICE_DETAILS		DeviceDetails;
#endif

	static UINT32 GetOutputSampleRate()
	{
#if WITH_MODERN_XAUDIO2
		return OutputSampleRate;
#else
		return DeviceDetails.OutputFormat.Format.nSamplesPerSec;
#endif
	}

	static DWORD GetOutputChannelMask()
	{
#if WITH_MODERN_XAUDIO2
		return OutputChannelMask;
#else
		return DeviceDetails.OutputFormat.dwChannelMask;
#endif
	}
